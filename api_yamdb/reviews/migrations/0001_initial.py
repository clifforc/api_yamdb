# Generated by Django 3.2 on 2024-08-04 12:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256)),
                ('year', models.IntegerField(help_text='Введите год произведения, не больше текущего.', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(2024)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(help_text='Введите целое число от 1 до 10.', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='Оценка')),
